...
namespace Decorator.Structural
{
    ...
    internal class MainApp
    {
        ...
        private static void Main()
        {
            ...
            var danificado = new ConcreteDecoratorDanificado();
            ...
            danificado.SetComponent(d2);
            
            danificado.Operation();
    ...
    internal class ConcreteDecoratorDanificado : Decorator
    {
        public override void Operation()
        {
            base.Operation();

            Console.WriteLine("ConcreteDecoratorDanificado.Operation()");
        }
    }
